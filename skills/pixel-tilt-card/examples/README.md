...
Nothing here is required by the skill — `SKILL.md`, `scripts/` and
`template/` are the working parts. These files exist only so people can see
what the skill produces before running it.
